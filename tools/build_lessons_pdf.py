...
SRC = "/home/user/workspace/urm/model/EgD-LGS-001.md"
OUT = "/home/user/workspace/urm/docs/blueprint/EVEglyphDesign_Gated_Sections_and_Basic_Lessons.pdf"
TS = datetime.datetime.now(datetime.timezone.utc).strftime("%Y-%m-%dT%H:%M:%SZ")
DOC_ID = "EgD-LGS-001"; KEY_ID = "EgD-KEY-2026-07"
TITLE = "Gated Sections and Basic Lessons"
SUB = ("The numbered teaching structure for the four chapters of the PAIX educational game: "
       "eight sections, eight gates, three lesson primitives, one arithmetic lesson per chapter.")
...
def paint(canvas, doc):
    ...
    canvas.drawString(MARGIN_L, H - 15*mm,
                      "EVEglyphDesign  \u00b7  Gated Sections and Basic Lessons  \u00b7  " + DOC_ID)
...
def cover(canvas, doc):
    ...
    canvas.drawString(MARGIN_L, y + 34*mm, "E V E G L Y P H D E S I G N   \u00b7   B L U E P R I N T   \u00b7   L 0")
...
def build():
    ...
    story = [
        ...
        Paragraph(
            ...
            f'&nbsp;&nbsp;\u00b7&nbsp;&nbsp;<font name="Inter-SB">Status</font>  structure v1.0 \u2014 NOT BUILT, AWAITING APPROVAL'
