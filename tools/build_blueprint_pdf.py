...
SRC = "/home/user/workspace/urm/model/EgD-URM-001.md"
OUT = "/home/user/workspace/urm/docs/blueprint/EVEglyphDesign_Game_Universal_Reference_Model.pdf"
TS = datetime.datetime.now(datetime.timezone.utc).strftime("%Y-%m-%dT%H:%M:%SZ")
DOC_ID = "EgD-URM-001"; KEY_ID = "EgD-KEY-2026-07"
TITLE = "Universal Reference Model"
SUB = ("A numbered blueprint for a 3D educational game delivered at a URL on open standards, "
       "structured so every section maps outward to other reference models.")
...
def paint(canvas, doc):
    ...
    canvas.drawString(MARGIN_L, H - 15*mm,
                      "EVEglyphDesign  \u00b7  Game Universal Reference Model  \u00b7  " + DOC_ID)
...
def build():
    ...
    story = [
        ...
        Paragraph(
            ...
            f'&nbsp;&nbsp;\u00b7&nbsp;&nbsp;<font name="Inter-SB">Status</font>  blueprint v1.0 \u2014 FOR REVIEW AND APPROVAL'
